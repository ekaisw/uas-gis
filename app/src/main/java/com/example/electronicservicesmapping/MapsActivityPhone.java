...
public class MapsActivityPhone extends FragmentActivity implements OnMapReadyCallback {
    ...
    {
        String url = "https://tugasandrojek.000webhostapp.com/koneksi2.php";
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, new Response.Listener<JSONArray>() {
                        ...
                        for(int i=0; i<jumData; i++)
                        {
                            if (marker.getTitle().equals(nama[i]))
                            {
                                if (MarkerD[i])
                                {
                                    ...
                                    Intent pindahdetail = new Intent(MapsActivityPhone.this, DetailActivity.class);
                                ...
                                else
                                {
                                    ...
                                    Toast pesan = Toast.makeText(MapsActivityPhone.this, "Silahkan klik sekali lagi", Toast.LENGTH_SHORT);
            ...
            public void onErrorResponse(VolleyError error) {
                AlertDialog.Builder builder = new AlertDialog.Builder(MapsActivityPhone.this);
