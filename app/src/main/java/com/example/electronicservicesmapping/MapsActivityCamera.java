...
public class MapsActivityCamera extends FragmentActivity implements OnMapReadyCallback {

    private GoogleMap mMap;
    private String[] id,nama,jam_buka,jam_tutup,telpn,gambar;
    int jumData;
    ...
    {
        String url = "https://tugasandrojek.000webhostapp.com/koneksi3.php";
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response)
            {
                ...
                jam_buka = new String[jumData];
                jam_tutup = new String[jumData];
                        ...
                        for(int i=0; i<jumData; i++)
                        {
                            if (marker.getTitle().equals(nama[i]))
                            {
                                if (MarkerD[i])
                                {
                                    ...
                                    DetailActivity.jam_buka = jam_buka[i];
                                    DetailActivity.jam_tutup = jam_tutup[i];
                                    ...
                                    Intent pindahdetail = new Intent(MapsActivityCamera.this, DetailActivity.class);
                                ...
                                else
                                {
                                    ...
                                    Toast pesan = Toast.makeText(MapsActivityCamera.this, "Silahkan klik sekali lagi", Toast.LENGTH_SHORT);
            ...
            public void onErrorResponse(VolleyError error) {
                AlertDialog.Builder builder = new AlertDialog.Builder(MapsActivityCamera.this);
