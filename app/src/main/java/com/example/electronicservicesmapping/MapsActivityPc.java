...
public class MapsActivityPc extends FragmentActivity implements OnMapReadyCallback {
    ...
    {
        String url = "https://tugasandrojek.000webhostapp.com/koneksi.php";
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, new Response.Listener<JSONArray>() {
                        ...
                        for(int i=0; i<jumData; i++)
                        {
                            if (marker.getTitle().equals(nama[i]))
                            {
                                if (MarkerD[i])
                                {
                                    ...
                                    Intent pindahdetail = new Intent(MapsActivityPc.this, DetailActivity.class);
                                    ...
                                    else
                                    {
                                        ...
                                        Toast pesan = Toast.makeText(MapsActivityPc.this, "Silahkan klik sekali lagi", Toast.LENGTH_SHORT);
            ...
            public void onErrorResponse(VolleyError error) {
                AlertDialog.Builder builder = new AlertDialog.Builder(MapsActivityPc.this);
